...
export default function DashboardHeader({
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="show"
      className="relative bg-gradient-to-r from-orange-50 to-orange-100 border border-orange-200 rounded-2xl p-4 py-8 min-h-[100px] overflow-visible"
    >
      {/* Background Image */}
      <Image
      ...
      <div className="relative z-10 flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-bold text-orange-700 mb-2">{title}</h1>
