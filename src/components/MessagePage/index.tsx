...
import { IconSend, IconMessageCircle, IconSearch, IconCheck, IconUser, IconUsers } from "@tabler/icons-react";
...
export default function MessagePage() {
  ...
  return (
    <div className="flex h-[calc(100vh-100px)] mr-4 space-x-4">
        ...
        <CardHeader className="p-4 border-b">
          ...
          <div className="relative">
            <Input
              ...
              className="pl-10 pr-4 py-2 border-lightBorderV1 focus:border-mainTextHoverV1"
            />
      ...
      {/* Main Chat Interface */}
      <div className="flex-1 space-y-6 bg-mainBackgroundV1 p-6 rounded-lg border border-lightBorderV1">
        <div className="flex items-center justify-between">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
