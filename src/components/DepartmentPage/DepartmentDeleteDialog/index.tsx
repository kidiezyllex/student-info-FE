...
export const DepartmentDeleteDialog = ({
  ...
  const handleConfirm = async () => {
    try {
      ...
      toast.error(error?.response?.data?.message || "Có lỗi xảy ra khi xóa khoa!");
    }
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-mainTextV1">Xác nhận xóa khoa</DialogTitle>
        </DialogHeader>
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-red-800">
              ...
              <p>Hành động này không thể hoàn tác. Tất cả dữ liệu liên quan đến khoa này sẽ bị xóa vĩnh viễn.</p>
            </div>
          </div>
        </div>
